...
function s1_1_button_click(){
    window.location.href = "assets/php/help.php";
}

function s1_2_button_click(){
    window.location.href = "assets/php/store_page.php?category=refurbished";
}

function s1_3_button_click(){
    window.location.href = "assets/php/store_page.php?category=collectibles";
}
...
async function onItemJson(json, item_list){
    ...
    for(const item of json){
        ...
        a.href = "assets/php/item_page.php?id=" + encodeURIComponent(item_id);
...
function search_form_submit(event){
    ...
    if(search_value.length > 0){
        ...
        fetch("assets/php/item_search.php",{
            method: "post",
...
async function onSearchJson(json) {
    ...
    for(const item_summary of item_summaries){
        ...
        item.action = "assets/php/add_item_in_db.php";
        item.method = "POST";
