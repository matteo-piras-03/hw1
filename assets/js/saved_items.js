...
function getSavedItems(){
    item_list.innerHTML = "";
    fetch("../php/get_saved_items.php").then(onResponse).then(onJson);
}
...
async function onClickRemoveButton(event){
    ...
    await fetch("../php/delete_saved_item.php", {method: "post", body: formdata}).then(OnSavedItemResponse).then(onSavedItemText);
